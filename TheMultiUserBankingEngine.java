...
class User {
    ...
    public String toCommaSeperatedString(){
        return name + "," + cnic + "," + age + "," + accountType + "," + balance;
    }
}
...
public class TheMultiUserBankingEngine {
    ...
    public void saveToFile(ArrayList<User> users){
        try{
            ...
            for(User user : users){
                writer.write(user.toCommaSeperatedString() + "\n");
            }
            writer.close();
        } catch (Exception e){
        ...
        if(file.exists()){
            try(Scanner fileReader = new Scanner(file)){
                while(fileReader.hasNextLine()){
                    ...
                    User loadedUser = new User(name,cnic,age,accountType);
                    loadedUser.balance = balance;
